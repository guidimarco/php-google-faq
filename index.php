<?php
    ...
    ]; // faq-array --> question-array --> [ "question" => "string", "answer" => ["par1", "par2", ...], "links" => ["str_link" => "href", ... ]
    // var_dump($faq);

    function print_par($par, $link_array) {
        // return the paragraph with link
        $new_par = $par;

        foreach ($link_array as $str_link => $href) {
            $new_par = str_replace($str_link, "<a class=\"primary\" href=\"" . $href . "\">" . $str_link . "</a>", $new_par);
        };
                ...
                <?php foreach ($faq as $current_quest) { ?>
                    <div class="single-faq">
                        ...
                        <?php foreach ($current_quest["answer"] as $answer_par) { ?>
                            <p>
                                <?php echo print_par($answer_par, $current_quest["links"]); ?>
                            </p><?php
